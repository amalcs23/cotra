...
function printHelp() {
  ...
  if [ "$USAGE" == "up" ]; then
    ...
    println
    println " Examples:"
    println "   network.sh deployCC -ccn basic -ccp ../cotra-app/chaincode-javascript/ ./ -ccl javascript"
    ...
    println "      \033[0;32mdeployCC\033[0m - Deploy a chaincode to a channel (defaults to cotra-app)"
